...
public class StartupService : BackgroundService, IHealthCheck
{
    ...
    {
        return Task.FromResult(_isReady ? HealthCheckResult.Healthy("The startup task has completed.") : HealthCheckResult.Unhealthy("That startup task is still running."));
    }
